...
/** Input for the createGalleryItem mutation. */
...
/** The payload for the createGalleryItem mutation. */
export type CreateGalleryItemPayload = {
    __typename?: 'CreateGalleryItemPayload';
    /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the deleteGalleryItem mutation. */
export type DeleteGalleryItemInput = {
    /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: InputMaybe<Scalars['String']['input']>;
    /** Whether the object should be force deleted instead of being moved to the trash */
    forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
    /** The ID of the galleryItem to delete */
    id: Scalars['ID']['input'];
    /** Override the edit lock when another user is editing the post */
    ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteGalleryItem mutation. */
export type DeleteGalleryItemPayload = {
    __typename?: 'DeleteGalleryItemPayload';
    /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: Maybe<Scalars['String']['output']>;
    /** The ID of the deleted object */
    deletedId?: Maybe<Scalars['ID']['output']>;
...
/** The galleryItem type */
export type GalleryItem = ContentNode &
    DatabaseIdentifier &
    MenuItemLinkable &
    Node &
    ...
    UniformResourceIdentifiable & {
         ...
         */
        galleryItemId: Scalars['Int']['output'];
        /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
        guid?: Maybe<Scalars['String']['output']>;
        ...
        /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
        modifiedGmt?: Maybe<Scalars['String']['output']>;
        /** Connection between the GalleryItem type and the galleryItem type */
        preview?: Maybe<GalleryItemToPreviewConnectionEdge>;
        /** The database id of the preview node */
        previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
        /** Whether the object is a node in the preview state */
        previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The galleryItem type */
export type GalleryItemEnqueuedScriptsArgs = {
    after?: InputMaybe<Scalars['String']['input']>;
    before?: InputMaybe<Scalars['String']['input']>;
    first?: InputMaybe<Scalars['Int']['input']>;
    last?: InputMaybe<Scalars['Int']['input']>;
...
/** The galleryItem type */
export type GalleryItemEnqueuedStylesheetsArgs = {
    after?: InputMaybe<Scalars['String']['input']>;
    before?: InputMaybe<Scalars['String']['input']>;
    first?: InputMaybe<Scalars['Int']['input']>;
    last?: InputMaybe<Scalars['Int']['input']>;
...
/** The galleryItem type */
export type GalleryItemTitleArgs = {
    format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to galleryItem Nodes */
export type GalleryItemConnection = {
    /** A list of edges (relational context) between RootQuery and connected galleryItem Nodes */
    edges: Array<GalleryItemConnectionEdge>;
    /** A list of connected galleryItem Nodes */
    nodes: Array<GalleryItem>;
    /** Information about pagination in a connection. */
    pageInfo: GalleryItemConnectionPageInfo;
};

/** Edge between a Node and a connected galleryItem */
export type GalleryItemConnectionEdge = {
    /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
    cursor?: Maybe<Scalars['String']['output']>;
    /** The connected galleryItem Node */
    node: GalleryItem;
};

/** Page Info on the connected GalleryItemConnectionEdge */
export type GalleryItemConnectionPageInfo = {
    /** When paginating forwards, the cursor to continue. */
    endCursor?: Maybe<Scalars['String']['output']>;
    /** When paginating forwards, are there more items? */
    hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the GalleryItem type and the galleryItem type */
export type GalleryItemToPreviewConnectionEdge = Edge &
    GalleryItemConnectionEdge &
    OneToOneConnection & {
        __typename?: 'GalleryItemToPreviewConnectionEdge';
        /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
        cursor?: Maybe<Scalars['String']['output']>;
        /** The node of the connection, without the edges */
        node: GalleryItem;
...
export type RootMutation = {
    ...
    /** The createGalleryItem mutation */
    createGalleryItem?: Maybe<CreateGalleryItemPayload>;
    ...
    /** The deleteGalleryItem mutation */
    deleteGalleryItem?: Maybe<DeleteGalleryItemPayload>;
    ...
    /** The updateGalleryItem mutation */
    updateGalleryItem?: Maybe<UpdateGalleryItemPayload>;
...
/** The root mutation */
export type RootMutationCreateGalleryItemArgs = {
...
/** The root mutation */
export type RootMutationDeleteGalleryItemArgs = {
...
/** The root mutation */
export type RootMutationUpdateGalleryItemArgs = {
...
export type RootQuery = {
    ...
    /** Connection between the RootQuery type and the galleryItem type */
    gallery?: Maybe<RootQueryToGalleryItemConnection>;
    /** An object of the galleryItem Type.  */
    galleryItem?: Maybe<GalleryItem>;
    /**
     * A galleryItem object
     * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
     */
    galleryItemBy?: Maybe<GalleryItem>;
...
export type RootQueryGalleryArgs = {
    ...
    first?: InputMaybe<Scalars['Int']['input']>;
    last?: InputMaybe<Scalars['Int']['input']>;
    where?: InputMaybe<RootQueryToGalleryItemConnectionWhereArgs>;
};

/** The root entry point into the Graph */
export type RootQueryGalleryItemArgs = {
    asPreview?: InputMaybe<Scalars['Boolean']['input']>;
    id: Scalars['ID']['input'];
    idType?: InputMaybe<GalleryItemIdType>;
};

/** The root entry point into the Graph */
export type RootQueryGalleryItemByArgs = {
    galleryItemId?: InputMaybe<Scalars['Int']['input']>;
    id?: InputMaybe<Scalars['ID']['input']>;
    slug?: InputMaybe<Scalars['String']['input']>;
...
/** Connection between the RootQuery type and the galleryItem type */
export type RootQueryToGalleryItemConnection = Connection &
    GalleryItemConnection & {
        __typename?: 'RootQueryToGalleryItemConnection';
        /** Edges for the RootQueryToGalleryItemConnection connection */
        edges: Array<RootQueryToGalleryItemConnectionEdge>;
        /** The nodes of the connection, without the edges */
        nodes: Array<GalleryItem>;
        /** Information about pagination in a connection. */
        pageInfo: RootQueryToGalleryItemConnectionPageInfo;
    };

/** An edge in a connection */
export type RootQueryToGalleryItemConnectionEdge = Edge &
    GalleryItemConnectionEdge & {
        __typename?: 'RootQueryToGalleryItemConnectionEdge';
        /** A cursor for use in pagination */
        cursor?: Maybe<Scalars['String']['output']>;
        /** The item at the end of the edge */
        node: GalleryItem;
...
/** Page Info on the &quot;RootQueryToGalleryItemConnection&quot; */
export type RootQueryToGalleryItemConnectionPageInfo =
    GalleryItemConnectionPageInfo &
        PageInfo &
        WpPageInfo & {
            __typename?: 'RootQueryToGalleryItemConnectionPageInfo';
            /** When paginating forwards, the cursor to continue. */
            endCursor?: Maybe<Scalars['String']['output']>;
            /** When paginating forwards, are there more items? */
            hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToGalleryItemConnection connection */
export type RootQueryToGalleryItemConnectionWhereArgs = {
    /** Filter the connection based on dates */
    dateQuery?: InputMaybe<DateQueryInput>;
    /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
    hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Input for the updateGalleryItem mutation. */
export type UpdateGalleryItemInput = {
    /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: InputMaybe<Scalars['String']['input']>;
    /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
    date?: InputMaybe<Scalars['String']['input']>;
    /** The ID of the galleryItem object */
    id: Scalars['ID']['input'];
    /** Override the edit lock when another user is editing the post */
    ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
    /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateGalleryItem mutation. */
export type UpdateGalleryItemPayload = {
    __typename?: 'UpdateGalleryItemPayload';
    /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: Maybe<Scalars['String']['output']>;
    /** The Post object mutation type. */
    galleryItem?: Maybe<GalleryItem>;
...
export type UpdateSettingsInput = {
    ...
    >;
    /** Allow link notifications from other blogs (pingbacks and trackbacks) on new articles. */
    discussionSettingsDefaultPingStatus?: InputMaybe<
        Scalars['String']['input']
    >;
    /** A date format for all date strings. */
